/*
  ...
  变量：export htxtk='token1&deviceCoding1@token2&deviceCoding2'  多个账号用@或者换行分割 
 ...
 */
 ...
 let name = '';
 let url = {
    url: 'http://carbontest.dcps.info:8074/signIn/sign/',
    headers: {
 ...
 !(async () => {
     ...
     if (!(await Envs()))
         ...
         for (let index = 0; index < htxtkArr.length; index++) {
 
 
             let num = index + 1
             console.log(`\n========= 开始【第 ${num} 个账号】=========\n`)
 
             data = htxtkArr[index].split('&');
 ...
 function signIn(timeout = 3 * 1000) {
     url.url = 'http://carbontest.dcps.info:8074/signIn/sign'
 ...
 */
   function share(timeout = 3 * 1000) {
    url.url = 'http://carbontest.dcps.info:8074/community/share/accomplish'
  ...
  */
   function getQue(timeout = 3 * 1000) {
    url.url = 'http://carbontest.dcps.info:8074/community/requestQuestion'
 ...
 */
  function doQue(num1) {
    url.url = 'http://carbontest.dcps.info:8074/community/answerQuestion'
 ...
 */
  function getCal(timeout = 3 * 1000) {
    url.url = 'http://carbontest.dcps.info:8074/interact/data'
    url.body = `{"token":"${data[0]}","platform":"android","model":"MI8","version":"1.1.1_VersionCode_111","deviceCoding":"${data[1]}","language":"ZH","systemversion":"10"}`
    return new Promise((resolve) => {
 ...
 */
  function doCal(num2) {
    url.url = 'http://carbontest.dcps.info:8074/interact/collect'
 ...
 */
  function getExchange(timeout = 2 * 1000) {
    url.url = 'http://carbontest.dcps.info:8074/myCarbonAssets/myData'
    url.body = `{"token":"${data[0]}","platform":"android","model":"MI8SE","version":"1.1.1_VersionCode_111","deviceCoding":"${data[1]}","language":"ZH","systemversion":"10"}`
    return new Promise((resolve) => {
 ...
 async function Envs() {
     if (htxtk) {
         if (htxtk.indexOf("@") != -1) {
             htxtk.split("@").forEach((item) => {
                 htxtkArr.push(item);
             });
         } else if (htxtk.indexOf("\n") != -1) {
            htxtk.split("\n").forEach((item) => {
                htxtkArr.push(item);
            });
         } else {
